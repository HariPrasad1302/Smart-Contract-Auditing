...
const Trusted = () => {
  return (
    <>
      <div className="py-4 px-12 mt-32">
        <div className="container my-14 mx-auto md:px-6">
          <section className="text-center ">
            <div className="grid gap-6 md:grid-cols-1">
              <div className="mb-6 md:mb-0 space-y-12">
                <h2 className="mb-6 text-4xl font-bold">
                  Trusted by 2,00,000+ Developers and Auditors
                </h2>

                <p className="mb-6 text-neutral-500 dark:text-neutral-300">
                  Lorem ipsum dolor sit, amet consectetur adipisicing elit.
                  Saepe, quas.Lorem ipsum dolor sit, amet consectetur
                  adipisicing elit. Saepe, quas.Lorem ipsum dolor sit, amet
                  consectetur adipisicing elit. Saepe, quas.
                </p>
