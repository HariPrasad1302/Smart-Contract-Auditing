      ...
      <div className="relative max-w-screen-xl  px-8 md:px-12 lg:px-16 xl:px-4 py-16 mx-auto  bg-white bg-opacity-5 border-2 border-white border-opacity-10 bg-blur-lg text-gray-900 sm:rounded-lg shadow-lg">
        ...
        <div className="relative">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 lg:mx-12">
            {/* Testimonial 1 */}
            <div className="relative mx-auto mt-8 rounded-lg shadow-lg max-w-sm p-10 bg-opacity-70 bg-white bg-blur-md text-gray-700 leading-snug flex flex-col justify-between">
              <div className="-ml-4">
                ...
                <div className="flex items-center">
                  <div>
                    <img className="w-12 h-12 rounded-full border-2 border-indigo-400"
                      src="https://avatars2.githubusercontent.com/u/2741?s=64&v=4" alt="Testimonial author"/>
                  </div>
                  <div className="ml-4">
            ...
            {/* Testimonial 2 */}
            <div className="mx-auto mt-8 rounded-lg shadow-lg max-w-sm p-10 bg-opacity-70 bg-white bg-blur-md text-gray-700 leading-snug flex flex-col justify-between">
              <div className="-ml-4">
                <svg className="w-8 opacity-25 text-indigo-500" xmlns="http://www.w3.org/2000/svg"
                  shapeRendering="geometricPrecision" textRendering="geometricPrecision" imageRendering="optimizeQuality"
                  fillRule="evenodd" clipRule="evenodd" viewBox="0 0
...
<path
              ...
              <div>
                ...
                <div className="flex items-center">
                  <div>
                    <img className="w-12 h-12 rounded-full border-2 border-indigo-400"
                      src="https://avatars0.githubusercontent.com/u/810438?s=100" alt="Testimonial author"/>
                  </div>
                  <div className="ml-4">
